...
def registerwin():
    ...
    f_name=Label(register_frame,text="First Name",font=("helvetica",14,"bold"),bg="snow2")
    ...
    l_name=Label(register_frame,text="Last Name",font=("helvetica",14,"bold"),bg="snow2")
    ...
    user=Label(register_frame,text="User ID",font=("helvetica",14,"bold"),bg="snow2")
    ...
    password=Label(register_frame,text="Password",font=("helvetica",14,"bold"),bg="snow2")
    password.grid(row=3,column=0,padx=10, pady=5)
    
    passtxt=Entry(register_frame,bd=5,relief=GROOVE,font=("",15))
    passtxt.grid(row=3,column=1,padx=10, pady=5)
    
    conf_password=Label(register_frame,text="Confirm Password",font=("helvetica",14,"bold"),bg="snow2")
    conf_password.grid(row=4,column=0,padx=10, pady=5)
    
    conf_passtxt=Entry(register_frame,bd=5,relief=GROOVE,font=("",15))
    conf_passtxt.grid(row=4,column=1,padx=10, pady=5)
    
    phone=Label(register_frame,text="Phone Number",font=("helvetica",14,"bold"),bg="snow2")
    ...
    email=Label(register_frame,text="Email ID",font=("helvetica",14,"bold"),bg="snow2")
    ...
    label_note=Label(register_frame,text="Register as a:",font=("helvetica",14,"bold"),bg="snow2")
...
def Loginwin():
    ...
    user=Label(login_frame,text="User ID",font=("helvetica",14,"bold"),bg="#EFEFEF")
    user.grid(row=1,column=0,pady=10)
    usertxt=Entry(login_frame,bd=5,relief=GROOVE,font=("",15))
    usertxt.grid(row=1,column=1,padx=10)
    passw=Label(login_frame,text="Password",font=("helvetica",14,"bold"),bg="#EFEFEF")
    passw.grid(row=2,column=0,pady=10)
    passtxt=Entry(login_frame,bd=5,relief=GROOVE,font=("",15))
    passtxt.grid(row=2,column=1,padx=10)
    btn=Button(login_frame,text="Login",command=login,relief=RAISED,font=("helvetica",15,"bold"),bg="white",fg="black")
    btn.grid(row=3,column=1,padx=(20,20), pady=30)
    btn1=Button(login_frame,text="Signup",command=move_register,relief=RAISED,font=("helvetica",15,"bold"),bg="white",fg="black")
    btn1.grid(row=3,column=0,padx=(60,0), pady=30)

    frame2=Frame(loginwindow,bd=0,bg="#EFEFEF")
    frame2.place(x=235,y=675)

    btn3= Button(frame2, text="Cancel" , font=("helvetica",12,"bold"),bg="white", fg="black")
...
feedbut_pic=PhotoImage(file="images/cartadd.png")
...
def Disp_img(newtext):
	...
	try:
		...
		for i in range (0,len(prodlist)):
			...
			for_product.grid(row=countrow,column=countcol,padx=10,pady=20)
			prod=ImageTk.PhotoImage(file=imgsavepath)
			item_view_Label=Label(for_product,image=prod,bd=0)
			...
			description=Label(for_product,text="",bd=0,bg="white",font=("times_new_roman",20,"bold"))
...
def orderwin():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS transaction(tid INTEGER(50) NOT NULL , mode VARCHAR(100) NOT NULL,pid integer(10) references cart(CProduct_ID),usrn varchar(15) references register(userid))")
    ...
    frame_1.place(x=10,y=70,width=800,height=600)
    ...
    Nametxt=Entry(frame_1,font=("times new roman",15,"bold"),bg="lightyellow",fg="black")
    ...
    emailtxt=Entry(frame_1,font=("times new roman",15,"bold"),bg="lightyellow",fg="black")
    ...
    statetxt=Entry(frame_1,font=("times new roman",15,"bold"),bg="lightyellow",fg="black")
    ...
    info=Label(frame_1,text="Note:",font=("times new roman",15,"bold"),fg="black")
    info.place(x=10,y=330)
    info2=Label(frame_1,text="please pay the amount to the following and enter transaction details in next page,",font=("times new roman",15,"bold"),fg="black")
    info2.place(x=10,y=360)
    info3=Label(frame_1,text="upi=abc@axis or gpay=9292929292",font=("times new roman",15,"bold"),fg="black")
    info3.place(x=10,y=390)
    info4=Label(frame_1,text="bank account_no=123,ifsc=8282x829",font=("times new roman",15,"bold"),fg="black")
    info4.place(x=10,y=420)
    info5=Label(frame_1,text="Thank You....!",font=("times new roman",15,"bold"),fg="black")
    info5.place(x=10,y=450)
    
    #second
    frame2=Frame(croot,bd=3,relief=RIDGE)
    frame2.place(x=820,y=70,width=500,height=350)
    ...
    frame3.place(x=820,y=420,width=500,height=250)
...
def Feedwin():
	...
	Feedwindow.geometry("450x450+500+150")
	Feedwindow.configure(background = "white")
	def submit():
	...
	Sub_Feedwindow.place(x=45,y=55)
	page_frame=LabelFrame(Sub_Feedwindow,width=400,height=400)
	page_frame.pack(side=LEFT)

	title=Label(Feedwindow,text="Feedback",font=("calibri",15,"italic"))
	title.place(x=0,y=0,relwidth=1)
	pn=Label(page_frame,text="Product Name",font=("helvetica",12,"bold"),bg="#EFEFEF")
	pn.grid(row=1,column=0,pady=10)
	pntxt=Entry(page_frame,bd=5,relief=GROOVE,font=("",12))
	pntxt.grid(row=1,column=1,padx=10)
	pid=Label(page_frame,text="Product Id",font=("helvetica",12,"bold"),bg="#EFEFEF")
	pid.grid(row=2,column=0,pady=10)
	pidtxt=Entry(page_frame,bd=5,relief=GROOVE,font=("",12))
	pidtxt.grid(row=2,column=1,padx=10)
	pdate=Label(page_frame,text="Purchase Date",font=("helvetica",12,"bold"),bg="#EFEFEF")
	...
	pidecr=Label(page_frame,text="Feedback",font=("helvetica",12,"bold"),bg="#EFEFEF")
	pidecr.grid(row=4,column=0,pady=10)
	pidecrtxt=Entry(page_frame,bd=5,relief=GROOVE,font=("",8))
	pidecrtxt.grid(row=4,column=1,padx=10,ipady=40,ipadx=40)
	btn=Button(page_frame,text="Submit",relief=RAISED,command=submit,font=("helvetica",12,"bold"),bg="white",fg="black")
...
def Cartwin():
	...
	RmProd.pack(padx=50,pady=20)

	cartbutframe=Frame(cartwindow,bg="green")
	cartbutframe.pack(side=BOTTOM,anchor=S)
	...
	cart_but.grid(row=0,column=0,padx=15,pady=20)
	...
	cart_but.grid(row=0,column=1,padx=15,pady=20)
...
search_but.grid(row=0,column=5,padx=10)
...
cart_but=Button(title_bar,image=cartic,bd=0,bg="white",activebackground="#F0F0F0",cursor="hand2",command=Cartwin)
cart_but.grid(row=0,column=7,padx=10)
...
user_info.grid(row=0,column=8,padx=10)
...
feedbut=Button(page_heading,image=feedbut_pic,text="Feedback",compound=LEFT,bg="white",activebackground="#F0F0F0",cursor="hand2",bd=0,command=Feedwin)
feedbut.place(x=1000,y=5)
...
categorylabel=Label(sub_frame1,text="Categories",bd=0,bg="white",font=("Ravie",20,"bold"),anchor=N,padx=15,pady=10)
...
sub_frame3.place(x=15,y=340)
Note_1=Label(sub_frame3,text="7 Farmers Killed \ndue to Bad Harvest",font=("Helvetica",14,"bold"),fg="black",bd=0,justify="center",bg="white")
Note_1.pack(fill=BOTH)
sub_note_1=Label(sub_frame3,text="Menshinkai became cheap so due to \nloss the family lost money and \nhas to kill it self to save face.\nBad Harvests are blamed on climate\n but receive no help.\n Save farmers!! Save Menshinkai",bg="white",font=("Helvetica",10,"bold"),fg="black",bd=0,justify="center")
