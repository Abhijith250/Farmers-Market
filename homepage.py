...
def blogopen():
	os.system('c:/Users/Alpha/Desktop/DBMS/Abhiset/Blog/Blog.html')

def moreopen():
	os.system('c:/Users/Alpha/Desktop/DBMS/Abhiset/Blog/Main.html')
...
spacer1=Label(title_frame, bg="white",width=80)
