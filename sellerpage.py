...
con=pymysql.connect(host="localhost",user="root",password="",database="registeration")
cur=con.cursor()
...
cur.execute("CREATE TABLE IF NOT EXISTS feedback(p_name VARCHAR(100) NOT NULL, p_id INTEGER(50) NOT NULL PRIMARY KEY, p_date VARCHAR(100) NOT NULL, descr VARCHAR(1000) NOT NULL)")
...
def Loginwin():
  ...
  #btn2=Button(login_frame, text="Forgot Password",relief=RAISED,font=("helvetica",15,"bold"),bg="white",fg="black")
...
def frame_1_show():
  ...
  #Frame 1 Contents
   ...
   Main_Inventory.column("Prod_ID",anchor=CENTER,width=100)
   Main_Inventory.column("Prod_Name",anchor=CENTER,width=100)
   ...
   Main_Inventory.tag_configure('EvenRow',background="#82E686")
   ...
   Main_Inventory.pack(padx=200,pady=80,anchor=CENTER)
   ...
   Categoryentry = ttk.Combobox(entryframe,font=("",16),width=5,height=5) 
  ...
  #frame for buttons
   ...
   ButFrame.pack(side=TOP,padx=20,pady=10)
...
def show_Detail():
    ...
    Detail.geometry("400x520+350+180")
...
def frame_2_show():
  ...
  Sub_Inventory.column("#0",width=50,stretch=NO)
  Sub_Inventory.column("Order_ID",anchor=CENTER,width=180)
...
# =============================================================================
      for record in data:
          ...
          Sub_Inventory.insert(parent='',index='end',iid=i,text="",values=(record[4],record[0],record[1]))
          for r in data2:
              pro=r[2]
              ...
              for k in row:
                  ...
                  Sub_Inventory.insert(parent=i, index='end',text="",values=(k[0],k[1],k[2]))
                  j+=1
          i+=1
# =============================================================================
...
# =============================================================================
  ...
  Sub_Inventory.pack(padx=280,pady=130,anchor=CENTER)
  
  Disp_info=Button(frame_2,text="Details",font=("",15),command=show_Detail)
  Disp_info.pack(pady=30)
...
def frame_3_show():
    ...
    Sub1_Inventory.tag_configure('EvenRow',background="#82E686")
    ...
    Sub1_Inventory.pack(padx=250,pady=200,anchor=W)
    
    Dispmssg3=Label(frame_3,text="View Feedback Details",font=("",24))
...
#prod1=ImageTk.PhotoImage(file="images/1.png")
...
logo.grid(row=0,column=1,padx=510,pady=3)
logout=Button(title_bar,text="logout",command=logout,font=("Helvetica",10,"bold"),bg="white")
...
shift_frame_0=Button(side_menu,text="Home",width=15,font=("Helvetica",15,"bold"),bg='snow2',command=home_show)
shift_frame_0.pack(pady=20)
shift_frame_1=Button(side_menu,text="Product Operations",width=15,font=("Helvetica",15,"bold"),bg='snow2',command=frame_1_show)
shift_frame_1.pack(pady=20)

shift_frame_2=Button(side_menu,text="View Orders",width=15,font=("Helvetica",15,"bold"),bg='snow2',command=frame_2_show)
shift_frame_2.pack(pady=20)

shift_frame_3=Button(side_menu,text="Feedback",width=15,font=("Helvetica",15,"bold"),bg='snow2',command=frame_3_show)
...
page_frame=LabelFrame(Sub_root,width=1155,height=725)
...
but1=Button(pgback,image=icon,text="Product Operations",command=frame_1_show,compound=TOP,height=250,width=200,font=("Helvetica",15,"bold")).place(x=100,y=200)
but2=Button(pgback,image=icon,text="View Products",command=frame_2_show,compound=TOP,height=250,width=200,font=("Helvetica",15,"bold")).place(x=400,y=200)
but3=Button(pgback,image=icon,text="Feedback",command=frame_3_show,compound=TOP,height=250,width=200,font=("Helvetica",15,"bold")).place(x=700,y=200)

#first frame
frame_1=Label(page_frame,image=backg_page)

#second frame
frame_2=Label(page_frame,image=backg_page,width=2155,height=725)

#third frame
frame_3=Label(page_frame,image=backg_page)
